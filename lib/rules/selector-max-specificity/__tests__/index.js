...
testRule(rule, {
  ...
  reject: [ {
    code: "a span {}",
    description: "too many tagnames",
    message: messages.expected("a span", "0,1,1"),
  }, {
    code: ".ab span::after {}",
    description: "too many tagnames",
    message: messages.expected(".ab span::after", "0,1,1"),
  }, {
    code: ".ab .cd {}",
    description: "too many classnames",
    message: messages.expected(".ab .cd", "0,1,1"),
  }, {
    code: ".ab:hover {}",
    description: "too many classnames",
    message: messages.expected(".ab:hover", "0,1,1"),
  }, {
    code: "#hello {}",
    description: "too many ids",
    message: messages.expected("#hello", "0,1,1"),
  } ],
})

testRule(rule, {
  ruleName,
  config: [ "1,3,1", { granular: true } ],
  ...
  accept: [ {
    ...
    code: ".list .item:hover a {}",
  }, {
    code: ".menu .list .item {}",
  }, {
    code: ".menu .list .item a {}",
  }, {
    code: "#header .menu .list .item {}",
  } ],

  reject: [ {
    code: "a span {}",
    description: "too many tagnames",
    message: messages.expected("a span", "1,3,1"),
  }, {
    code: ".item a::after {}",
    description: "too many tagnames",
    message: messages.expected(".item a::after", "1,3,1"),
  }, {
    code: ".nav .menu .list .item {}",
    description: "too many classnames",
    message: messages.expected(".nav .menu .list .item", "1,3,1"),
  }, {
    code: ".menu .list .item a:hover {}",
    description: "too many classnames",
    message: messages.expected(".menu .list .item a:hover", "1,3,1"),
  }, {
    code: "#app #header {}",
    description: "too many ids",
    message: messages.expected("#app #header", "1,3,1"),
  } ],
})
